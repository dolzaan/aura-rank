...
export function VideoFeed({ className }: { className?: string }) {
  return (
    <section
      className={clsx(
        "feed-shell mx-auto h-dvh w-full max-w-[520px] overflow-hidden bg-black md:mt-16 md:h-[calc(100dvh-4rem)] md:rounded-t-[28px] md:border-x md:border-t md:border-white/10",
        className,
      )}
    >
